...
// Happy path test: create a user and verify it appears in the list
...
// Duplicate email test: create a user, then attempt to create the same user again and verify the error alert
